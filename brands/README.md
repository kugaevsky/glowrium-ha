...
# resize + quantize to a 256-colour palette (flat icon -> ~6/14 KB, visually identical)
magick brands/icon-source-144.png -filter Lanczos -resize 256x256 -colors 256 -strip brands/icon.png
magick brands/icon-source-144.png -filter Lanczos -resize 512x512 -colors 256 -strip "brands/icon@2x.png"
